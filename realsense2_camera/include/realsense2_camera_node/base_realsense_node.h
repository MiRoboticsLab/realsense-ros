...
namespace realsense2_camera
{
    ...
    protected:
        ...
        std::string _align_config_file_path;
        rs2_intrinsics _other_intrinsics;
        rs2_extrinsics _z_to_other;
        bool _pause_mode;
    ...
    private:
        ...
        void publishAlignFrame(uint8_t* imgdata,rs2::frame f, const rclcpp::Time& t,
                                     const stream_index_pair& stream,
                                     std::map<stream_index_pair, cv::Mat>& images,
        ...
        void publishAlignedFrame(rs2::frame f, const rclcpp::Time& t,
                          const stream_index_pair& stream,
                          std::map<stream_index_pair, cv::Mat>& images,
                          const std::map<stream_index_pair, rclcpp::Publisher<sensor_msgs::msg::CameraInfo>::SharedPtr>& info_publishers,
                          const std::map<stream_index_pair, std::shared_ptr<image_publisher>>& image_publishers,
        ...
        uint8_t* align_z_to_other(const rs2::video_frame& depth, float z_scale);
        ...
        std::shared_ptr<image_publisher> _depth_aligned_rgb_publisher;
        ...
        bool emitter_on_off_available;
        bool use_emitter_on_off; 
        double _current_time1;
        double _last_time1;
        double _current_time2;
        double _last_time2;
    };//end class
